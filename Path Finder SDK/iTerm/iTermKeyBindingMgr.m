...
- (NSString *) keyCombinationAtIndex: (int) index inProfile: (NSString *) profile
{
	...
	switch (keyCode)
	{
		case NSDownArrowFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"cursor down",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSLeftArrowFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"cursor left",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSRightArrowFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"cursor right",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSUpArrowFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"cursor up",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSDeleteFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"del",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case 0x7f:
			aString = NTLocalizedStringFromTableInBundle(@"delete",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSEndFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"end",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		...
		case NSHelpFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"help",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");	
			break;
		case NSHomeFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"home",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case '0':
		...
		case NSClearLineFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"numlock",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSPageDownFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"page down",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSPageUpFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"page up",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case 0x3: // 'enter' on numeric key pad
			aString = NTLocalizedStringFromTableInBundle(@"enter",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		case NSInsertCharFunctionKey:
			aString = NTLocalizedStringFromTableInBundle(@"insert",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names");
			break;
		...
		default:
			aString = [NSString stringWithFormat: @"%@ 0x%x", 
				NTLocalizedStringFromTableInBundle(@"hex code",@"iTerm", 
														 [NSBundle bundleForClass: [self class]], 
														 @"Key Names"),
				keyCode];
			break;
...
- (NSString *) actionForKeyCombinationAtIndex: (int) index inProfile: (NSString *) profile
{
	...
	switch (action)
	{
		case KEY_ACTION_NEXT_SESSION:
			actionString = NTLocalizedStringFromTableInBundle(@"next tab",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_NEXT_WINDOW:
			actionString = NTLocalizedStringFromTableInBundle(@"next window",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_PREVIOUS_SESSION:
			actionString = NTLocalizedStringFromTableInBundle(@"previous tab",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_PREVIOUS_WINDOW:
			actionString = NTLocalizedStringFromTableInBundle(@"previous window",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_SCROLL_END:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll end",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_SCROLL_HOME:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll home",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;			
		case KEY_ACTION_SCROLL_LINE_DOWN:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll line down",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_SCROLL_LINE_UP:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll line up",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_SCROLL_PAGE_DOWN:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll page down",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_SCROLL_PAGE_UP:
			actionString = NTLocalizedStringFromTableInBundle(@"scroll page up",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		case KEY_ACTION_ESCAPE_SEQUENCE:
			actionString = [NSString stringWithFormat:@"%@ %@", 
				NTLocalizedStringFromTableInBundle(@"send ^[",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions"),
				auxText];
			break;
		case KEY_ACTION_HEX_CODE:
			actionString = [NSString stringWithFormat: @"%@ %@", 
				NTLocalizedStringFromTableInBundle(@"send hex code",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions"),
				auxText];
			break;			
		case KEY_ACTION_IGNORE:
			actionString = NTLocalizedStringFromTableInBundle(@"ignore",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions");
			break;
		default:
			actionString = [NSString stringWithFormat: @"%@ %d", 
				NTLocalizedStringFromTableInBundle(@"unknown action ID",@"iTerm", 
															  [NSBundle bundleForClass: [self class]], 
															  @"Key Binding Actions"),
				action];
			break;
...
- (NSDictionary *) globalProfile
{
	...
	globalProfile = NTLocalizedStringFromTableInBundle(@"Global",@"iTerm", [NSBundle bundleForClass: [self class]], @"Key Binding Profiles");
